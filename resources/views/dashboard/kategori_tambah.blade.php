...
<section class="section">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
        <div class="card-body">
            <h5 class="card-title mb-3 pb-0">Tambah Item Baru</h5>
            <form action="{{ asset('/dashboard/kategori/tambah_action/') }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row mb-3">
                    <label for="nama_item" class="col-lg-2 col-form-label">Nama Item</label>
                    <div class="col-lg-10">
                        <input name="nama_item" type="text" class="form-control" id="nama_item" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-10">
                        <select class="form-select" name="kategori" required>
                            <option selected hidden value="Lain Lain">Pilih Kategori</option>
                ...
                <div class="row mb-3 mt-3">
					...
					<div class="col-sm-10">
						<input class="form-control mb-2" id="gambar" type="file" accept="image/*" name="gambar" required>
						<img src="https://placehold.it/80x80" hidden="true" id="preview" style="max-width: 400px;" >
					</div>
				</div>
                @push('scripts')
